...
public class JCublas2Sample
{
    ...
    public static void testSgemm(int n)
    {
        ...
        //Performing Sgemm with Java...5.5s n = 1000
        System.out.print("Performing Sgemm with Java...");
		long start = System.currentTimeMillis();
        sgemmJava(n, alpha, h_A, h_B, beta, h_C_ref);
		System.out.println( ( System.currentTimeMillis() - start ) * 0.001 + "s" );
		//Performing Sgemm with JCublas...0.23s n = 1000  
        System.out.print("Performing Sgemm with JCublas...");
