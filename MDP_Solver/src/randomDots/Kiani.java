...
public class Kiani {
	...
	static double R_P = 50; //450  for Ssp_data
	static double R_N = 0;
	static double R_B = R_P * 0.85;
	...
	static public void main(String [] args){
		...
		String rewardLable = String.format("%.1f_%.1f_%.1f_%.1f_Kiani", R_S,R_P,R_N,R_B);
